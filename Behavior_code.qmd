...
```{r}
#Changing the format of the columns to work with brms
f.tpsawns.tvisits <- rename(behavior_sheet_sep, total.spawns = 'Total Spawns', total.female.visits = 'Total Female Visits')

#Total spawns as a function of total female visits
f.tspawns.tvisits.mdl <- brm(data = f.tpsawns.tvisits,
      family = gaussian,
      total.spawns ~ total.female.visits,

...
f.tspawns.tvisits.mdl <- brm(data = behavior_sheet_cln, #Gives the model the tibble
      ...
      file = 'output/f.tspawns.tvisits') #Saves the model as an object for outputting later
...
fvisits.nmagg.mdl <-
  brm(data = fvisits.nmagg, #Give the model the tibble
      ...
      file = 'output/fvisits.nmagg.mdl') #saves it as an output
...
f.spawns.nmagg.mdl <-
  brm(data = f.visits.nmagg, #Give the model the tibble
      ...
      iter = 2000, warmup = 1000, chains = 4, cores = 4, #Markov chain parameters
      seed = 4, #Determines which random numbers
      file = 'output/f.visits.nmagg.mdl') #saves it as an output
...
f.visits.satagg.mdl <-
  brm(data = behavior_sheet_cln, #Give the model the tibble
      ...
      iter = 2000, warmup = 1000, chains = 4, cores = 4, #Markov chain parameters
      seed = 4, #Determines which random numbers
      file = 'output/f.visits.satagg.mdl') #saves it as an output
...
f.spawns.satagg.mdl <-
  brm(data = behavior_sheet_cln, #Give the model the tibble
      ...
      iter = 2000, warmup = 1000, chains = 4, cores = 4, #Markov chain parameters
      seed = 4, #Determines which random numbers
      file = 'output/f.spawns.satagg.mdl') #saves it as an output
